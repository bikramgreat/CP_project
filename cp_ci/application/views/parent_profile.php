...
//                                $("#dashbord_main_content_view_hidden_div").css('display', 'block');
        ...
        function load_report_form_for_parent() {



//                    $("#dashbord_main_content_view_hidden_div").css('display', 'none');
//                    $("#dashbord_main_content_view_div").load("<?php //echo base_url();?>//School/load_report_view_form");
//                    $("#dashbord_main_content_view_div").css('display', 'block');


            $("#dashbord_main_content_view_hidden_div").css('display', 'block');
            $("#dashbord_main_content_view_div").load("<?php echo base_url();?>School/load_report_view_form", function () {

                load_report_student_select_div();
            });

        }

        function load_report_student_select_div() {
             //alert('dsfasf');

                $.ajax({
                    url:"<?php echo base_url();?>User_controller/get_report_view_student_list",
                    mathod:"post",
                    data:{},
                    success:function (student_list) {
                        //alert (student_list);
                        document.getElementById('Report_student_select_list').innerHTML=student_list;
        ...
        function get_student_report_for_parent(student_id) {
             //alert (student_id);
            $.ajax({
                url:"<?php echo base_url();?>User_controller/get_student_report_for_parent",
                mathod:"post",
...
<?php include('parent_view/parent_dashboard_nav.php');?>
<!-- <div hidden=""></div> -->
