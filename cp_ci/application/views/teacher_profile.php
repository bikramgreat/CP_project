              ...
              function view_homework_form() {
                  $('#view_homework_button').click(
                      function () {
                             //  alert('sdjf');
                          $("#dashbord_main_content_view_hidden_div").css('display', 'block');
                          $("#dashbord_main_content_view_hidden_div").load("<?php echo base_url();?>School/load_homework_view_form_teacher");
                          $("#dashbord_main_content_view_div").css('display', 'none');
                      }
                  );
...
//              }
        ...
        function add_roll_no() {
          ...
          function select_student_reg_account_id(student_account_id) {
              //alert (student_account_id);
        ...
        function get_report()
        {
            ...
            if(account_id==""||class_no==""||student_value=="")
            {
                    ...
                    data: [
                        {
                            ...
                            dataPoints: [
                                { y: a_attendance, indexLabel: " Absentday number in %" },
                                { y: p_attendance, indexLabel: " Present day number in %" },
...
<body style="background-color: #aec3f3;">
  ...
  <?php include('teacher_view/teacher_dashboard_nav_div.php');?>
  <!-- <div hidden=""></div> -->
