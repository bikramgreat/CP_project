<form class="container" id="teacher_signup_form" style="background-color:#afc3f6; " method="post" action="<?php echo base_url()?>Controller_teacher/ct_sign_up" enctype="multipart/form-data">
         ...
         <div  class="col-md-4" style="">
              ...
              <div class="form-horizontal"  >
                ...
                <label  for="teacher_reg_id">Teacher Resistration ID:</label> 
                <input type="text" class="form-control" id="teacher_reg_id" required="" name="teacher_reg_id">
        ...
        <div style="width: 50%;margin-left: 25%;">
            ...
            <a href=" <?php echo base_url();?>school/login" >Cancle</a>
