<div class="container-fluid" id="student_add_form">
				...
				<div  class="col-md-4">
				       <b><p style="text-align: center; color: red; font-size: 150%;">Student Registration</p></b>
						  ...
						  <div class="form-group"> 
						    <div class="col-sm-offset-2 col-sm-10">
						      <button class="btn btn-primary active" id="student_save_button" onclick="insert_student_registration();">Register student</button>
