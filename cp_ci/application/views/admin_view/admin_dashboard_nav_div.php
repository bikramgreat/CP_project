    ...
    <div class="col-md-2" style="background-color:#d4cff8;" id="dashbord_buttons_div">
        ...
        <div class="dropdown" style="margin-top: 5px;">
            ...
            <ul class="dropdown-menu" style="width: 100%;">
                ...
                <li><button class="btn btn-primary active" id="view_student_detail_button" style="width:100%; margin-top: 20px; font-size: 110%;">student detail</button><li/>
                ...
                <li><button class="btn btn-info"  id="add_event_button" style="width:100%; margin-top: 20px; font-size: 110%;">Add Events</button><li/>
                ...
                <li><button class="btn btn-primary active" id="add_student_button" style="width:100%; margin-top: 20px; font-size: 110%;">Add Student</button><li/>
