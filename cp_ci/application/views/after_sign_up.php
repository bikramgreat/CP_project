...
<body>
   <div style="width: 100%; height: 300px; text-align: center;">
     <p style="font-size: 500%">Hello, Welcome <?php echo $user_name;?></p>
     <p style="font-size: 200%">Your accunt have been created</p>
   </div>
   <form action="<?php echo base_url();?>school/login" method="post">
   	 <div class="col-md-4"></div>
   	 <div style="width: 100%; height: 300px;" class="col-md-4">
   	   <a href="signin.php" style="margin-top: 50px; width: 100%;" ><button type="submit" style="width:100%;  margin-top: 10px; height: 100px; font-size: 150%">SIGN IN NOW</button></a>
   	 </div>
     <div class="col-md-4"></div>
   </form>
