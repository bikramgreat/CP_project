...
//            {
//                $.ajax({
//                    url:"<?php //echo base_url();?>//User_controller/log_out",
//                    mathod:"post",
//                    data:{},
//                    success:function () {
//
...
//        };
        ...
        function update_student_registration() {
            ...
            var student_age=$('#student_student_age').val()
            var student_address=$('#student_address').val();
            var student_reg_id=document.getElementById('student_reg_id_update').innerHTML;
            // alert (student_reg_id);
            if (year==""||month==""||day=="") {
                alert ("please enter date of birth");
            ...
            {
                $.ajax({
                    url:"<?php echo base_url()?>Controller_admin/ca_update_registering_student",
                    mathod:"post",
                    data:{student_reg_id:student_reg_id,student_first_name:student_first_name,student_last_name:student_last_name,student_age:student_age,student_date_of_birth:student_date_of_birth,student_address:student_address},
                    success:function (massage) {
                        alert (massage);
                        //document.getElementById("all_online_user_list").innerHTML=user_list;
                    }
...
//                                $("#dashbord_main_content_view_hidden_div").css('display', 'block');
        ...
        function get_registered_student_list() {
            $("#view_student_detail_button").click(function () {

                $("#dashbord_main_content_view_div").css('display', 'none');
                $("#dashbord_main_content_view_hidden_div").css('display', 'block');
                $('#dashbord_main_content_view_hidden_div').load("<?php echo base_url();?>School/load_student_list_div", function () {
                    $.ajax({
                        url:"<?php echo base_url();?>Controller_admin/get_reg_student_list",
                        mathod:"post",
                        data:{},
                        success:function (student_list) {
                            //alert (student_list);
                            document.getElementById('list_div').innerHTML=student_list;
        ...
        function get_registered_student_list_by_input() {
            var value=document.getElementById('student_value_input').value;
                    $.ajax({
                        url:"<?php echo base_url();?>Controller_admin/get_reg_student_list_by_input",
                        mathod:"post",
                        data:{value:value},
                        success:function (student_list) {
                            //alert (student_list);
        ...
        function registered_student_update(reg_id,first_name,last_name,date_of_birth,age,address) {

               var date_value=date_of_birth.split("-",3);
               var year=date_value[0];
               var month=date_value[1];
               var day=date_value[2];
                  //alert (year);
                $("#dashbord_main_content_view_div").css('display', 'none');
                $("#dashbord_main_content_view_hidden_div").css('display', 'block');
                $('#dashbord_main_content_view_hidden_div').load("<?php echo base_url();?>School/load_student_reg_update_div", function () {
                    document.getElementById('student_reg_id_update').innerHTML=reg_id;
                    ...
                    document.getElementById('student_student_age').value=age;
                    document.getElementById('student_address').value=address;
...
<body style="background-color: #aec3f3;" onbeforeunload="ConfirmClose()">
<?php include('common_view/dashboard_header.php');?>
<?php include('admin_view/admin_dashboard_nav_div.php');?>
<!-- <div hidden=""></div> -->
