    ...
    <div class="col-md-2" style="background-color:#d4cff8;" id="dashbord_buttons_div">
        ...
        <div class="dropdown" style="margin-top: 5px;">
            ...
            <ul class="dropdown-menu" style="width: 100%;">
                ...
                <li><button class="btn btn-primary active" id="view_attendance_button" style="width:100%; margin-top: 20px; font-size: 110%;"  onclick="load_attendance_view_div();">View Attendance</button><li/>
                ...
                <li><button class="btn btn-primary active" id="" style="width:100%; margin-top: 20px; font-size: 110%;" onclick="load_report_form_for_parent();">Student Report</button><li/>
